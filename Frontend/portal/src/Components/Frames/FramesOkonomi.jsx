...
import Soliditet from "../../Graphs/Okonomigrafer/okonomi"
        ...
        return (
            ...
            <div className="row-frames">
                <div className="column-frames">
                    <Frame overskrift= "Soliditet" tekst={"Dette diagrammet viser bedriftens økonomiske soliditet for 2021"} graph={<Soliditet/>}/>
                </div>
                <div className="column-frames">
