            ...
            <div className="row-frames okonomi-frame">
                <div className="column-frames">
                    <Frame overskrift= "Soliditet" 
                            tekst={`Diagrammet viser ${orgname} sin økonomiske soliditet for 2021.`} 
                ...
                <div className="column-frames">
                    <Frame overskrift="Likviditet" 
                            tekst={`Diagrammet viser ${orgname} sin økonomiske likviditet for 2021.`}
                            graph={<Likviditet id={id}/>}
                            dropDown={"Likviditet forklart"}
                            show={"Likviditet viser selskapets evne til å betale sine forpliktelser når de forfaller. Tallet regnes ut ved å dele selskapets omløpsmidler (tilgjengelige midler) på kortsiktig gjeld. Tallene er hentet fra regnskapsregisteret."}
                            kilde={"Kilde: Regnskapsregisteret"}/>
                </div>
                <div className="column-frames">
