    ...
    <div className="row_forside">
      <div className="column_forside">
        <div className="card_forside card-virksomheter">
          <div>
            ...
            <a href="/">
              <img
                src={require("./Images/Pil-ikon.png")}
          ...
          <div>
            <p className="p_card_forside">
              Samlet oversikt over alle selskaper (AS) kategorisert etter
              bransje.
            </p>
          </div>
        </div>
      ...
      <div className="column_forside">
        <div className="card_forside card-barekraft">
          ...
          <div>
            <p className="p_card_forside">
              Les mer om FNs bærekraftsmål og Norges handlingsplan for å nå
              bærekraftsmålene.
            </p>
          </div>
        </div>
      ...
      <div className="column_forside">
        <div className="card_forside card-regelverk">
          ...
          <div>
            <p className="p_card_forside">
              Oversikt over eksisterende og kommende regelverk på
              bærekraftsområde.
            </p>
          </div>
        </div>
